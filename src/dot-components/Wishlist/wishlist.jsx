        ...
        <div class="wishlist-cards align-justify-center">
            {wishState.wish.map((item) => 
                ...
                <div class="footer">
                    ...
                    <button class="btn primary-btn" onClick={ ()=> cartDispatch({type : "Increase_quantity", payload : item})}>Increase quantity</button> : 
                    <button class="btn primary-btn" onClick={ ()=> cartDispatch({type : "Add_to_cart", payload : item})}>Move to cart</button> }
                    <button class="button read-btn" onClick = { ()=> wishDispatch({type : "Remove_from_wishlist", payload : item})}>Remove <i class="fas fa-heart wish-icon"></i></button>
                </div>
                </article>
            )}
