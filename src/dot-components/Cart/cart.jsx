                    ...
                    <div class="horizontal-content">
                        ...
                        <div class="main-info-cont align-justify-center">
                            ...
                            <div class="quantity-cont align-justify-center">
                                ...
                                <button class="quantity-btn inc" onClick={() => cartDispatch({type : "Increase_quantity", payload : item})}><i class="fal fa-plus"></i></button>
                                <div class="product-quantity">{item.quantity}</div>
                                <button class="quantity-btn dec" onClick={() => cartDispatch({type : "Decrease_quantity", payload : item})}><i class="fal fa-minus"></i></button>
                            </div>
                            <div class="flex-prop">
                                <button class="btn secondary-btn rem-btn" onClick={() =>cartDispatch({type : "Remove_from_cart", payload : item})}>Remove from Cart</button>
                                {wishState.wish.find((product) => product._id === item._id) ?
                                <Link to = "/wishlist">
                                    <button class="button read-btn">Go to Wishlist</button>
                                </Link> : 
                                <button class="button read-btn" onClick= {()=>wishDispatch({type : "Add_to_wishlist", payload : item})}>Add to wishlist</button>
                                }
