...
import { getCategories, getProducts, getCartProducts, getWishlistProducts, removeCartProduct, removeWishlistProduct, postCartProduct, postWishlistProduct } from "../services/products";
...
const ProductProvider = ({children}) =>{
    ...
    return(
        <ProductContext.Provider value={{productState, productDispatch, getCart, getWishlist, removeFromWishlist, removeFromCart}}>{children}</ProductContext.Provider>
    )
}
